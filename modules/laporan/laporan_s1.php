...
<aside class="right-side">
    ...
    <section class="content-header" style="background:#EDEDED"><h1>
            ...
            <small>Program Studi : S1 TI</small>
        </h1></section>
    <section class="content-header">                    
        <form method="post">
        ...
        if (isset($_POST['proses'])) {
            ...
            $sql="select * from pembayaran where DATE_FORMAT(tgl_bayar,'%Y-%m-%d')>='$awal' and DATE_FORMAT(tgl_bayar,'%Y-%m-%d')<='$akhir' and kd_prodi='S1TI' and angkatan='$angkatan' and jenis_pembayaran='$jenis' and periode='$periode' and status='$status' order by nim asc";
            //$sql = "select * from pembayaran where tgl_bayar between tgl_bayar='$awal' and tgl_bayar='$akhir' and kd_prodi='S1TI' and angkatan='$angkatan' and jenis_pembayaran='$jenis' and status='$status'";
        } else {
            $sql = "SELECT * FROM pembayaran where kd_prodi='S1TI' order by nim asc";
        }
        ?>                    
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-info">
            <div class="box-header">
                <!-- <h3 class="box-title">Rekapitulasi Pembayaran Mahasiswa</h3> -->
