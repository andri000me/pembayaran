...
header("content-disposition: attachment;filename=laporan_keuanganD3TI".date('dmY').".xls")
?>
...
<html>
    ...
    <body>
        ...
        $sql="select * from pembayaran where DATE_FORMAT(tgl_bayar,'%Y-%m-%d')>='$awal' and DATE_FORMAT(tgl_bayar,'%Y-%m-%d')<='$akhir' and kd_prodi='D3TI' and angkatan='$angkatan' and jenis_pembayaran='$jenis' and periode='$periode' and status='$status'";
        ?>
