...
<aside class="right-side">
    ...
    <section class="content-header" style="background:#EDEDED"><h1>
                       ...
                       <small>Program Studi : D3 MI</small> 
                    </h1></section>
    <section class="content-header">                    
                    <form method="post">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-xs-7">
                                    ...
                                    <a id="pdf"  class="btn btn-primary"   href="http://localhost/SMS/pembayaran/modules/laporan/laporan_pdf_d3mi.php?tgl_awal=<?php echo $_POST['awal']; ?>&tgl_akhir=<?php echo $_POST['akhir'];?>&kd_prodi=<?php echo $_POST['prodi']; ?>&angkatan=<?php echo $_POST['angkatan']; ?>&jenis_pembayaran=<?php echo $_POST['jenis'];?>&periode=<?php echo $_POST['periode'];?>&status=<?php echo $_POST['status'];?>" target="_blank"><i class="fa  fa-print"></i> Cetak PDF</a>
                                     <a id="exel"  class="btn btn-primary"   href="http://localhost/SMS/pembayaran/modules/laporan/laporan_exel_d3mi.php?tgl_awal=<?php echo $_POST['awal']?>&tgl_akhir=<?php echo $_POST['akhir'];?>&kd_prodi=<?php echo $_POST['prodi'] ?>&angkatan=<?php echo $_POST['angkatan'] ?>&jenis_pembayaran=<?php echo $_POST['jenis'] ?>&periode=<?php echo $_POST['periode'];?>&status=<?php echo $_POST['status'] ?>" target="_blank"><i class="fa fa-file-excel-o"></i> Cetak Excel</a>
                                    <a class="btn btn-primary" href="http://localhost/SMS/pembayaran/modules/laporan/lap_d3mi.php" target="_blank"><i class="fa fa-file-excel-o"></i> Cetak Semua</a>
                                </div>
                            </div>
                        </div>      
                        <script>
                    ...
                    if (isset($_POST['proses'])) {
                        ...
                        $sql = "select * from pembayaran where tgl_bayar>='$awal' and tgl_bayar<='$akhir' and kd_prodi='D3MI' and angkatan='$angkatan' and jenis_pembayaran='$jenis' and status='$status' order by nim asc";
                    } else {
                        $sql = "SELECT * FROM pembayaran where kd_prodi='D3MI' order by nim asc";
                    }
                    ?>                    
                </section>
