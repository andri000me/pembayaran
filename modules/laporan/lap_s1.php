                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                          ...
                                                          <?php 
                                                                ...
                                                                $sql1 = "SELECT SUM(jumlah) AS total_uang FROM pembayaran where kd_prodi='S1TI' ";
                                                                    $result = mysql_query($sql1) or die (mysql_error());
                                                                    $t = mysql_fetch_array($result);
                                                                    $biaya=($t['total_uang']);
                                                                echo "<td colspan='1'> <h5>Rp. " . number_format($t['total_uang']) . " </h5></td>";
                                                            $sql2 = "SELECT SUM(denda) AS total_denda FROM pembayaran where kd_prodi='S1TI' ";
