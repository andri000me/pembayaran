...
header("content-disposition: attachment;filename=laporan_keuanganS1TI".date('dmY').".xls")
?>
...
<html>
    ...
    <body>
        ...
        $sql="select * from pembayaran where DATE_FORMAT(tgl_bayar,'%Y-%m-%d')>='$awal' and DATE_FORMAT(tgl_bayar,'%Y-%m-%d')<='$akhir' and kd_prodi='S1TI' and angkatan='$angkatan' and jenis_pembayaran='$jenis' and periode='$periode' and status='$status'";
        ?>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                         ...
                                                         <?php 
                                                                ...
                                                                $sql1="SELECT SUM(jumlah) AS total_uang FROM pembayaran where kd_prodi='S1TI' and angkatan='$angkatan' and jenis_pembayaran='$jenis' and DATE_FORMAT(tgl_bayar,'%Y-%m-%d')>='$awal' and DATE_FORMAT(tgl_bayar,'%Y-%m-%d')<='$akhir' and periode='$periode'";
                                                            ...
                                                            echo "<td>Rp " . $total . " </td>";
                                                            $sql2 = "SELECT SUM(denda) AS total_denda FROM pembayaran where kd_prodi='S1TI' and angkatan='$angkatan' and jenis_pembayaran='$jenis' and DATE_FORMAT(tgl_bayar,'%Y-%m-%d')>='$awal' and DATE_FORMAT(tgl_bayar,'%Y-%m-%d')<='$akhir' and periode='$periode'";
