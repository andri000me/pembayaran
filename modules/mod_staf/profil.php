 ...
 <aside class="right-side">
                ...
                <div class="pad margin no-print">
                    <div class="alert alert-info" style="margin-bottom: 0!important;">
                        ...
                        <b><h4>Info:</b> Selamat Datang, <?php echo  $_SESSION['nama'];?> Di Halaman Akun Anda.</h4>
                    </div>
                </div>
                 <?php
                ...
                <section class="content invoice">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <h2 class="page-header">
                                <i class="glyphicon glyphicon-user"></i> IDENTITAS STAF KEUANGAN
                    ...
                    <div class="row no-print">
                        <div class="col-xs-12">
                            ...
                            <a href="#"><button class="btn btn-success pull-right" data-toggle="modal" data-target="#compose-modal"><i class="glyphicon glyphicon-edit"></i> Ubah Profil</button></a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><i class="glyphicon glyphicon-user"></i> Ubah Profil Staf</h4>
                    </div>
                    <form action="index.php?modul=ubah_profil" method="POST">
